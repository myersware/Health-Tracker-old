...
import {Component, OpaqueToken, provide, Inject, Input, Output, EventEmitter} from 'angular2/core';
...
interface AppState { todos: ITodo[]; visibilityFilter: string; }
...
// -- statefn
function todos(initState: ITodo[], actions: Observable<Action>): Observable<ITodo[]> {
...
function updateTodo(todo: ITodo, action: Action): ITodo {
